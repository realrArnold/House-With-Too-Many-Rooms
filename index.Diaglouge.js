...
Foyer.description = "everything just as you remember it, the seemingly infinte stairs upwards, the rotten smell that remains,regardless of how many times the place was cleaned, and the 20 or so clocks on the wall all stuck at 4:37";
const WestHall = new Room("West Hall");
WestHall.description = "The long hall ahead. Somehow narrow desipte how wide it looks from the doorway. The feeling of claustrophobia sets in ever so slightly. Adorned on the walls are  paintings. <br>The first of the door to the house the one you already came through,</br> <br> the second of a kitchen in the melting style of Salvadoir Dali,</br><br>The 3rd a life paiting of the study filled with people, they have no faces...</br> <br>the forth, a photograph of a bathroom mirror,</br> <br>the fith a piccaso styled painting of the bedroom. There is a black rectangle in the space of where a wardrobe should be. </br> ";
const EastHall = new Room("East Hall");
EastHall.description = "The Short hall ahead. It feels impossibly wide,wider than the mansion would suggest";
const Diningroom = new Room("Dining Room");
Diningroom.description = "A table, so long it stretches out from one end of the room to the other";
const SecondFloorLanding = new Room("2nd Floor Landing");
SecondFloorLanding.description = "More rooms to explore on your left and right and more clocks stuck on 4:37. Does this house have an end";
const Kitchen = new Room("kitchen");
Kitchen.description = "a large isalnd for prepping food in the center and at the back, several kitchen appliances";
const LivingRoom = new Room("Living Room");
LivingRoom.description = "Two sofas facing each other, a coffee table between them. To the right a lit fireplace and in front of you have a window facing outside.";
const Study = new Room("Study");
Study.description = "A desk in the middle of the room commanding auhtroity just like the person sitting in it. The bookshelfs stretch all the way to the ceiling";
const EastLanding = new Room("East Landing");
EastLanding.description = "A dusty hallway, it looks like it hasnt been walked across, let alone cleaned in years";
const EastBedroom = new Room("East Bedroom");
EastBedroom.description = "A small single bed with some cartoon character on the sheets, on the floor various toys. You remeber having these. Like the hall this place is covered in dust";
const Bathroom = new Room("Bathroom");
Bathroom.description = "A large bath, looks like an olympic swimming pool compared to yours. Above the sink you see an expesnive decorative frame. It's a mirror";
...
WestBedroom.description = "A double bed, on it neatly folded clothes. The wallpaper appears to made of out doucments of some kind";
const MasterBedroom = new Room("Master Bedroom");
MasterBedroom.description = "A huge bedroom, bigger than most appartments. Through the wardrobe ";
...
SophieRedbarrow.description = "The sender of the letter, her presense is imposing. She weats a crimson dresss that looks like it came from the 19th century ";
const ButlerMori =new Character("Butler Mori")
ButlerMori.description ="The butler of the estate. The epitome of a stereotypical butler, the outfit, the demeanor. You are suprised he isn't called Jeeves"
